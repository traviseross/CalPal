...
- Personal Calendar → Personal Events (full details) → Work (Busy only)
- Family Calendar → Family Events (full details) → Work (Busy only)
...
class PersonalFamilyMirror:
    ...
    def load_calendars(self):
        ...
        self.personal_source = PERSONAL_CALENDAR_ID
        self.family_source = os.getenv('FAMILY_CALENDAR_ID', 'family@example.com')
